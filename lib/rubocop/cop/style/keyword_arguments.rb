  ...
  module Cop
    module Style
      ...
      class KeywordArguments < Cop
        MSG = 'Prefer only one positional argument per public method.'
        ...
        def check_node(node)
          find_suspect_methods(node).each do |_k, candidate_method|
            ...
            pos_args.each do |_positional_arg|
        ...
        def find_suspect_methods(node, modifier = :public)
          ...
          private_modified_methods.flatten.each do |modified_method|
